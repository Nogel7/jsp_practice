...
<body>
    ...
    <h2>web.xml 내부 welcomepage 설정에 index라고 적혀있어서</h2>
    ...
    <c:if test="${sessionScope.session_id eq null}">
	    <a href="http://localhost:8181/MyFirstWeb/users/login_form.jsp">로그인창</a><br/>
    ...
    <!-- 로그아웃버튼은 로그인한 사용자한테만 보입니다. 로그아웃 버튼을 로그인한 사용자만 보이게 만들어서 태그를 1:1로 보내주세요. -->
     <c:if test="${not empty sId}">
	    <a href="http://localhost:8181/MyFirstWeb/users/logout.jsp">로그아웃</a><br/>
    </c:if>
</body>
</html>