...
public class JDBCInsert {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("추가할 유저의 이메일를 입력해주세요.");
			...
			System.out.println("---------------------------");
			// 쿼리문 콘솔 출력 끝
			stmt.executeUpdate("INSERT INTO userinfo VALUES('" + uid + "','" + upw + "','" + uname + "','" + uemail +"')");
