...
<%  
    ...
    String name = null;
    String email = null;
    // 1. 세션에서 아이디를 얻어옵니다. 세션결과값이 널이면 login_form.jsp로 이동
